setting = {
    ...
    "group":"App",
    "apache": {
        "accesslog_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/access.log",
        "errorlog_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/error.log",
    ...
    "custom" :{
        "access_count_ip_top10":{
            "is_active":0,
            "file_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/access.log",
        ...
        "pms_req_count":{
            "is_active":0,
            "file_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/pms_interface_*.log",
        ...
        "pms_th_req_list_actions":{
            "is_active":0,
            "file_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/pms_threshold_logs_*.log",
            "dateformat":"%Y-%m-%d %H:%M",
        ...
        "dist_ticket_inflow_action":{ #last 5 miutes ticket table cound group by daemon|sync
            "is_active":0,
            "file_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/channel_pending_tickets_db_statistics_*.log",
            "dateformat":"%Y-%m-%d %H:%M",
            "time":5, # 0 equal to current date time as per format.
        ...
        "dist_ticket_serialcount_inprocess":{ #Last five minute action vise serial count
            "is_active":0,
            "file_path":"/home/jignesh/scripts/py_apps/data-agent-client/samplelog/channel_ticket_process_statistics_*.log",
            "dateformat":"%Y-%m-%d %H:%M",
            "time":5, # 0 equal to current date time as per format.
